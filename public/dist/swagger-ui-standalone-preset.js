  ...
  return (function (t) {
      ...
      t.exports = (function () {
        ...
        ;(Zt[Jt] = !0),
          ...
          (Kt.prototype.update = function (t, e, n, r, i, o, u) {
            ...
            var s = i === M
            if (n !== this.keyHash)
              return s ? this : (m(u), m(o), ae(this, t, e, n, [r, i]))
            for (
      ...
      var R = new h('tag:yaml.org,2002:omap', {
          ...
          resolve: function (t) {
            ...
            for (e = 0, n = s.length; e < n; e += 1) {
              if (((r = s[e]), (o = !1), '[object Object]' !== Y.call(r)))
                return !1
              for (i in r)
                if (U.call(r, i)) {
                  if (o) return !1
    ...
    function (t, e, n) {
      ...
      ;(function (e, r, i) {
        ...
        function w(t) {
          if (((s = s || n(55)), !(d.call(w, this) || this instanceof s)))
            return new w(t)
      ...
      var r = n(31),
        ...
        dt = function t(e) {
          ...
          if (
            ((B = o
              ? function (r) {
                  ...
                  V(r) &&
                    (q++,
                    p()(l) ? (R[L] = u()((f = R[L])).call(f, l)) : R[L].push(l))
                }
              : function (e, r) {
            ...
            var H
            if (
              ((H = at(void 0 !== r ? r : void 0 !== S ? S : e.default)), !o)
            ) {
          ...
          if ('object' === N) {
            ...
            if (!0 === T)
              o
                ? R[L].push({ additionalProp: 'Anything can be here' })
                : (R.additionalProp1 = {}),
                q++
            else if (T) {
              var nt = Object(I.d)(T),
                rt = t(nt, n, void 0, o)
              if (o && nt.xml && nt.xml.name && 'notagname' !== nt.xml.name)
                R[L].push(rt)
              else
                for (
                  var it =
          ...
          if ('file' !== N)
            return o ? ((R[L] = D()(m) ? F : [{ _attr: m }, F]), R) : F
        },
        yt = function (t, e, n) {
          return [t, j()(e), j()(n)]
        },
    ...
    function (t, e, n) {
      ...
      var r = n(0),
        ...
        yt = function (t, e) {
          var n = (at[t] = b($))
          return (
            X(n, { type: J, tag: t, description: e }),
            f || (n.description = e),
            n
          )
        },
        ...
        wt = function (t) {
          ...
          return (
            ...
            (!(n || !h(this, e) || !h(at, e) || (h(this, q) && this[q][e])) ||
              n)
          )
        },
        Mt = function (t, e) {
          ...
          if (n !== H || !h(at, r) || h(ct, r)) {
            var i = rt(n, r)
            return (
              !i || !h(at, r) || (h(n, q) && n[q][r]) || (i.enumerable = !0), i
            )
          }
        },
        _t = function (t) {
    ...
    function (t, e, n) {
      'use strict'
      n(0)(
        { target: 'Map', proto: !0, real: !0, forced: n(10) },
        { deleteAll: n(574) }
      )
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      r(
        { target: 'Map', proto: !0, real: !0, forced: i },
        {
          merge: function (t) {
            for (
              var e = u(this), n = o(e.set), r = arguments.length, i = 0;
              i < r;
    ...
    function (t, e, n) {
      ...
      ;(t.exports = function (t) {
        var e
        return (
          -1 !== r((e = Function.toString.call(t))).call(e, '[native code]')
        )
      }),
        (t.exports.__esModule = !0),
        (t.exports.default = t.exports)
